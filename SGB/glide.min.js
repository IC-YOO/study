/*!
 * Glide.js v3.5.2
 * (c) 2013-2021 JÄ™drzej ChaĹ‚ubek (https://github.com/jedrzejchalubek/)
    ...
    var K = {
            ...
            return n.on("move", (function (r) {
                ...
                e.Transition.after((function () {
                    n.emit("translate.jump"),
                        i.set(e.Sizes.slideWidth * t.index)
                }));
        ...
        Peek: function (t, e, n) {
            ...
            return b(i, "value", {
                ...
                set: function (t) {
                    v(t) ? (t.before = d(t.before), t.after = d(t.after)) : t = d(t),
                        i._v = t
                }
            }), b(i, "reductor", {
                get: function () {
            ...
            var i = {
                ...
                calculate: function () {
                    var e = this.move,
                        ...
                        s = 1;
                    if ("=" === o)
                        return t.settings.bound && d(r) > n ? void (t.index = n) : void (t.index = r);
                    if (">" !== o || ">" !== r)
                        if ("<" !== o || "<" !== r) {
                ...
                c = {
                    ...
                    move: function (i) {
                        ...
                        if (!t.disabled) {
                            var s = t.settings,
                                ...
                                h = 180 * r / Math.PI;
                            this.enable(),
                                d > f && h < u ? e.Run.make(e.Direction.resolve("".concat(a, "<"))) : d < -f && h < u ? e.Run.make(e.Direction.resolve("".concat(a, ">"))) : e.Move.make(),
                    ...
                    bindSwipeStart: function () {
                        ...
                        o && i.on(q[0], e.Html.wrapper, (function (t) {
                            ...
                            s && i.on(q[1], e.Html.wrapper, (function (t) {
                                n.start(t)
                            }), u)
                    },
                    unbindSwipeStart: function () {
                        i.off(q[0], e.Html.wrapper, u),
                            i.off(q[1], e.Html.wrapper, u)
                    },
